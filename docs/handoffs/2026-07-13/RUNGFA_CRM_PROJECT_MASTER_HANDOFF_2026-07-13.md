...
| 5d9dbe | Refactor CRM sidebar navigation grouping |
| 6929bb3 | Refactor customer table column order |
| fbf542cc | Refactor customer modal and fix document upload save |
...
- ห้ามให้ AI login/gดยื่น/จ่ายเงิน/OTP ใน e-WorkPermit แทนพนักงาน
